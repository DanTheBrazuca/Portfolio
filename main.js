...
if (langBtn)
  langBtn.setAttribute("aria-label", "Change language (current: PT)");
...
const strings = {
  pt: {
    ...
    aboutText:
      "Olá, eu sou o Daniel. Sou aluno da Fatec, atualmente no curso de Desenvolvimento de Software Multiplataforma.",
    workTitle: "Projetos",
  ...
  en: {
    ...
    aboutTitle: "About Me",
    aboutText:
      "Hi, I am Daniel. I study at Fatec in the Multiplatform Software Development course.",
    workTitle: "Projects",
    sortOldest: "Oldest",
    sortNewest: "Newest",
  ...
  es: {
    ...
    aboutTitle: "Sobre mí",
    aboutText:
      "Hola, soy Daniel. Estudio en Fatec en el curso de Desarrollo de Software Multiplataforma.",
    workTitle: "Proyectos",
...
const projects = [
  {
    ...
    descKey: "project1Text",
    url: "https://danthebrazuca.github.io/PRIMEIROSITE/",
    date: "2026-03-05",
  },
  {
    id: 2,
    titleKey: "project2Title",
    descKey: "project2Text",
    url: "https://danthebrazuca.github.io/SiteFatec1/",
    date: "2026-03-10",
  },
  {
    id: 3,
    titleKey: "project3Title",
    descKey: "project3Text",
    url: "https://danthebrazuca.github.io/Amazon/",
    date: "2026-03-15",
  },
  {
    id: 4,
    titleKey: "project4Title",
    descKey: "project4Text",
    url: "https://danthebrazuca.github.io/PDForms/",
    date: "2026-06-12",
  },
];
...
function renderProjects(order = "newest") {
  ...
  const currentLang = document.documentElement.lang.startsWith("pt")
    ? "pt"
...
function setLanguage(lang) {
  ...
  langBtn.setAttribute(
    "aria-label",
    `Change language (current: ${lang.toUpperCase()})`,
  );
...
function setColorblindMode(mode) {
  ...
  if (mode && mode !== "off") {
    ...
    colorblindBtn.setAttribute(
      "aria-label",
      `Colorblind mode selected: ${mode}. Close selection to continue.`,
    );
    ...
    colorblindBtn.setAttribute(
      "aria-label",
      "Colorblind mode off. Open options to select mode.",
    );
...
function openColorblindMenu() {
  ...
  if (open)
    announce("Colorblind option menu opened. Use arrows or tab to pick.");
